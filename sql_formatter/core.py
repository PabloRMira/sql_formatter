...
__all__ = ['MAIN_STATEMENTS', 'clean_query', 'preformat_statements', 'lowercase_query', 'add_whitespaces_query',
           'format_partition_by', 'remove_wrong_end_comma', 'format_select', 'format_from', 'format_join', 'format_on',
           'format_where', 'format_statement_line', 'format_statements', 'format_multiline_comments',
