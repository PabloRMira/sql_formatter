...
__all__ = ['MAIN_STATEMENTS', 'CAPITAL_STATEMENTS', 'capitalize_statements', 'remove_newlines_mspaces',
           'breakline_statement', 'format_select', 'format_from', 'format_join', 'add_whitespaces_between_symbols',
           'format_on', 'format_where', 'format_statement_line', 'format_statements', 'format_sql']
