...
__all__ = ['assert_and_print', 'remove_whitespaces_newline', 'remove_whitespaces_comments',
           'remove_redundant_whitespaces', 'mark_comments', 'split_comment_non_comment', 'identify_in_sql',
           'identify_newline_chars', 'replace_newline_chars', 'identify_select_from', 'split_by_select_from',
           'add_whitespaces_between_symbols', 'identify_end_of_fields', 'add_newline_indentation',
           'extract_outer_subquery', 'format_subquery', 'check_sql_query', 'check_skip_marker', 'identify_semicolon',
           'split_by_semicolon', 'identify_create', 'count_lines', 'find_line_number']
...
def identify_newline_chars(s):
    "Identify positions of newline characters in `s` ignoring comments and text in quotes"
    return identify_in_sql("\n", s)
...
def identify_select_from(s):
    "Identify positions of SELECT and FROM in query `s` ignoring comments and text in quotes"
    return identify_in_sql(["select", "from"], s)
